...
export function RuleTable({ rules, onUpdateRule, onDeleteRule, onReorderRule }: RuleTableProps) {
	return (
		<div style={{ display: "block", overflowX: "auto" }}>
			<table style={{ minWidth: "min-content" }}>
				<thead>
					<tr>
						<th style={{ width: "80px" }}>Order</th>
						<th style={{ width: "120px" }}>Match</th>
						<th style={{ width: "150px" }}>Input</th>
						<th style={{ width: "150px" }}>Field Name / Keywords</th>
						<th style={{ width: "200px" }}>Content to Fill</th>
							...
							<td>
								<label data-field>
									<input
										...
										value={rule.name}
										onChange={(e) =>
											onUpdateRule(rule.id, "name", e.target.value)
										}
